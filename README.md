...
**World's first full kit printer featuring native Monolith Style Belt routing!** 
...
Printer features:
- An external frame built from 3030 extrusions for extra rigidity
- Fixed gantry for maximum rigidity
...
- Linear rods for Y axis motion for easy install and simplicity
